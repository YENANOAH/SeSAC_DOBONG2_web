...
// console.log(new Date(1991, 12, 18)) 왜 1992가 나오는지
...
console.log(now.getDay(),'요일') // 0~6 (0sun, 1mon 일 ~ 토)
...
console.log(Math.min(50,10,1,-5))
console.log(Math.max(50,10,100,999))
...
console.log('난수2:', Math.ceil(Math.random()*9))
console.log('난수1:', Math.floor(Math.random()*10)+1)
